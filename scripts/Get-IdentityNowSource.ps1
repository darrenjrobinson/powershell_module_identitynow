    ...
    if ($v3Token.access_token) {
        try {
            if ($sourceID) {
                if ($accountProfiles) {
                    switch($api){
                        'default'{$IDNSources = Invoke-RestMethod -Method Get -Uri "$((Get-IdentityNowOrg).'Private Base API URI')/accountProfile/list/$($sourceID)" -Headers @{Authorization = "$($v3Token.token_type) $($v3Token.access_token)" }}
                    }
                    
                }
                else {
                    switch($api){
                        'default'{$IDNSources = Invoke-RestMethod -Method Get -Uri "$((Get-IdentityNowOrg).'Private Base API URI')/source/get/$($sourceID)" -Headers @{Authorization = "$($v3Token.token_type) $($v3Token.access_token)"}}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUICZgjdvPL/FHn270g0LLPP6D
# a/OgghMmMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUNZsqQmgVrgP7VUOzEwfP
# 06Qr2jwwDQYJKoZIhvcNAQEBBQAEggEAvYEbGR2uXJBElsy3GYO1aiA9sniTU4Uw
# DCFs2ttw0iaq532iDYql+KwuaUtVHHDXOV1ACbzJf/7RSbY9VJ9yjrhejBHQ21xU
# fOepi1Dk56fcerLRkV140w9+4Bs6JEVG/TP3KxCngAJtxPBsG3Nc3o24ixkndZ2d
# g1JItPjMxzzlejsgYKqfQ8QELp3utC0jXE0fXrLBDtv2B6CdDVqJ6Le6NZgM71pI
# Sgw72ebB7C2T8iJHhAHXnKQCW3SiU0yvw1/fF6Yx7CRTXHuM3n0OZ+v/IwRUaIbq
# PLVGD0IJA4hzzc1TPIN0Re8W6KUg7xt4HOVCwap/slgwzGzIihtW36GCAgswggIH
...
# Fw0yMDA2MTUwMjAyMzdaMCMGCSqGSIb3DQEJBDEWBBS69GD3uRlRYPvRf3KFTURZ
# n74FUTANBgkqhkiG9w0BAQEFAASCAQBm4XejXPkMWZg2yZwL6yV+bw0z/Pwjl74S
# aoqT6oltxzQV09meQrN6VzoaJ55miCCUWmLbWiRSa5lA/A7w3DaiQdWVgB6e6rvM
# HmcucviEkb5TLD47ejolRm1mn/fT8MtPWhoGwuzl5rkNzlcnP21eciV2juImeBGy
# L4PkygT1EBdNK3A013sSBwguR63GSdDw2wZ7WeEw3IUs6hq1YxY2g4OeRTXxYrsx
# RRGDQ7KWwPpXOJvH6mrfEIZJ6TpzQ9N8w9+xOoGngGhR9HWfAoSJbqt2P+jXERys
# 0WIWEiqp0GjBu24b4Weqk3ugORGlZTn84OK0NMjKvZtKvliaiiTx
