...
#>
    ...
    if ($v3Token.access_token) {
        try {
            switch($api){
                "private"{$url="https://$($IdentityNowConfiguration.orgName).api.identitynow.com/cc/api/role/create"}
                "beta"{$url="https://$($IdentityNowConfiguration.orgName).api.identitynow.com/beta/roles"}
            }
            $IDNNewRoles = Invoke-RestMethod -Method Post -Uri $url -Headers @{Authorization = "$($v3Token.token_type) $($v3Token.access_token)"; "content-type" = "application/json" } -Body $role
            return $IDNNewRoles
        }
        catch {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQURRdHACpbcQeNMV63nziqPIBF
# OrmgghMmMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUrrKEZp5htW3EVwJ+M8oY
# 6Y4IrxIwDQYJKoZIhvcNAQEBBQAEggEAiapDsFdvb4yDMumKt9gPzJvTFvlzyMsP
# 9dVSzTitzRQnvY7t1PfER8qh6hHqNy14m6ThU14KjoAN0xV00N67VxGqeWwj5OcE
# rArGTEYMttk0DB9c5IowtV7dHTEIMZrvHkG/0NH7XHtgtQ5n7XVktRq4/RimxR/0
# Fe/vX483yaS7BaDe9QHZyEsSwhKK9sH2mQyV74Hxk/CTbNFSobEO1pWzfb62ngDn
# mP329GrDC7jFvRplVhc7gGir4XFABc7ExDnc7p6089PdaakSkDfESD8ZuFc76syx
# gOlJWfS7UCqBqyDBmPjUewCJcz7DSmZRq/9Ythj/IEMs3Z2ml1hGfqGCAgswggIH
...
# Fw0yMDA2MTUwMjAyNDNaMCMGCSqGSIb3DQEJBDEWBBQqfFpJoI5kwgu+jrizKRGl
# fSFarTANBgkqhkiG9w0BAQEFAASCAQB77IpElPO2VXyplAxCtVhdSwmO/tangv0I
# zjoPZGeZ/H7qdDlsJRuVhPuQi8dIY+XnwzreR2GlqzYOxpW5ywefHhqfJDg80thn
# u6Csz/P6VbAZQOrhi+y9nglcPFs4PNA/rv15sHqgqAEe+B2SKiCXjtsBjzC7TNKP
# n5OWmXQZsxqTkeziuQOXJ6ZWxZVMuh2X1hddLPufS8nQUrlGBViooIiQEjslU8fh
# oL1ia4b4yCNLacxqcoZNPN5oecbE51it/BY9mKr9346RzsTEURRjjryi9MPWtphX
# j0oje0xkTFkByQ1Yjgtpg5eyHnjboS6jNM5mZNXD+qfb7QYvgs/o
