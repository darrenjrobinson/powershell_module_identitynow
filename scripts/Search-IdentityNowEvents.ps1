        ...
        try {             
            ...
            if ($iterations -gt 1) {
                ...
                $results = Invoke-RestMethod -Method Post `
                    -Uri $searchURLBase -Headers @{Authorization = "Bearer $($v3Token.access_token)"; "Content-Type" = "application/json" } `
                    -Body $filter    
                ...
                do {
                    if (($searchLimit - $offset) -gt 2500) {  
                        $results = Invoke-RestMethod -Method Post `
                            -Uri "$($searchURLBase)&offset=$($offset)" `
                            -Headers @{Authorization = "Bearer $($v3Token.access_token)"; "Content-Type" = "application/json" } `
                            -Body $filter 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDWukuBpbxJzQb8
# Ex7hWq7sMOqo4jdrU2IiEhm9Ll5ZzaCCIS4wggWNMIIEdaADAgECAhAOmxiO+dAt
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIA8UZc/KfvNm
# tydT4FqsJ/TCubBr1So3Tmo/8VpL/b0VMA0GCSqGSIb3DQEBAQUABIICABbr752w
# N6PT85OtRP3/eoMxio68Ywrgo7bMelecghDZpaFJoTV0Kg+ndT22xhLzpYAT4cqT
# ECsc71mYWJHOTFFHPmJqFOO6XLi8v2x2S2KC/gvwn6fNBCAvv+ry8+FwREkmDpz6
# JzEzlsJGD+NPgsO2fnLZosziExLC4OIxhYY+bI4AGLFBVmZbwtmweMMtHmTnR5Ss
# 02vCuTIZdDE/oEL/SxJjuNQWSGywfh8ZARAMdiEA0auea6P3+he8Ib7uJAScfKiS
# DoAZ0MKuc1ly4EMNsbXshNuffEtPg3x4O8zk82EB1cLxtXuXesyxrP73zy+aUV2M
# cnJLg8ibn+fsUjYK74BzGHW2cLmtir/zx5CYl4dTyBo4BCGTwspSate5YNGFYTMv
# 1bDsOVgpNDohJ4y+K6RfoTkzo8wb7ObNxvU4y2DcEpnbVzv+s6uCTYLONbriGGPW
# mCnbQnSBVP8CQvJFQrwasK+OIGJBaUaMxrR2jHRWYdkh4HrdTkAGm4A+O7RGpgyK
# h+f7AQtpaXyTOkZcffTtW/H/cKbQmM1lv7DzhiakefBxOFXwjvwdGXZSQjcQZPjd
# RSf+0VVXahJr7NM6urOsVe5ZdHQAkS5wpf+vatZ2wCeSpM1CJeAgFHFVdChu2uBp
# bKg4N8mgetKVgeGKS9dxFNFG61bYppvY0nXzoYIDIDCCAxwGCSqGSIb3DQEJBjGC
...
# MTEwMjA4MzA1OFowLwYJKoZIhvcNAQkEMSIEIE0qydQdSt3r+24t9GZ/9gQmAA/W
# U4jbP7XmZOJ9RCAXMA0GCSqGSIb3DQEBAQUABIICAJZWhseIu3VVRYOurpIEhDIn
# eZHf0sngUYRBHP/8Zh6JvFL9Nazth1HADz36AOMUBpjh+iDVJHEBGfWuRwCq7aMl
# /UmXBXPRdvmWpaHuc8YlEestiygvN/ot3tkv+I0R/VyATIsL/SOxC5KfoeKkEE2l
# GmWl042jO0IQmw1eQZyT/3JUkGUt1Vzb0Va3s2+e2kTilpZkWFH3M7f2aghl63Af
# a6K0rz4UZhy5AgWrCe9Y5793gOm16YfmGeydoXLWpLqnauH2rOGrUOS9qkZd2dPF
# ynlLab4PBE+NtRjHIQ0RtIVplv7clWV7VR/gZRgltVe4gOPVsn8Y5sjzRf3Y2FYI
# jI7ls39V+VBMv3/CxjGQG8xKphpBZkKzKhyJcGR/nGMcXvPkMQfnWtDygCXfh8xm
# jnvlet75sI3w2BXfGjgfbcYBWyHrJLQ22sUT7tLtzPGrCUhRtsIpsLAzyOy8OJxC
# kc+10kLu4EkgkazZA1BvfpTBYNWF5ePjQTICGx+3VMClDrdqYrTcp/FBkJAd4O2N
# ZVKqwRzi6igxcxV2pNrRahVE5J/gSmZrfGcav8pVZn3Y4SrLQlSk8uQcm1wiPM4H
# QI6d4AhwlabPeR+kICQnplIVXJ51gaLH41ghTfXbXB6MmkZ/3mwjXbLsHq9XiLHG
# Swa8BzFd1deyLIulbqB5
