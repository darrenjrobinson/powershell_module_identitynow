...
.PARAMETER id
(optional) but required when using the V3 API (BETA) Roles API  
...
#>
    ...
    if ($v3Token.access_token) {
        try {
            if ($V3API) {
                $IDNUpdateRole = Invoke-RestMethod -Method Patch -Uri "https://$($IdentityNowConfiguration.orgName).api.identitynow.com/beta/roles/$($id)" -Headers @{Authorization = "$($v3Token.token_type) $($v3Token.access_token)"; "content-type" = "application/json-patch+json" } -Body $update
            }
            else {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU6r0QIiThHuYSoMM/vtDIekhI
# o6WgggqNMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFGjAPi5hhsMM
# v5r7Jhnvk3+44gXvMA0GCSqGSIb3DQEBAQUABIIBADakioUdfHF8kDc9Jf0pykjP
# Een8/krd4AP0hyKa9xnemHySBmXM2L1xdQca0BDjVHHRnsA90Q7mAUx0k14SHeKx
# wTOKWqP/29jlttM0nGh6Idi6Lm4ea8PPSxxyN+FV7Lr214ovnB7GUC/3LJXdT3wC
# vT0/rDrGMMsGxsDHebLr82cfPJbJnRwC6kCl/pBprVgNE7XKZQA7wR3CPVlTfvSa
# aAtB80s1OcIRstn8+1xsG1jeormZSOGteYpdZBArwD9+jCY4lwUUAU70dz2dIokS
# Wi7vhGdou4ThX0Ei5QcyAliiChYgrT/Jy7G6mnVDUBtgLY243r4bxv4O9USuw34=
