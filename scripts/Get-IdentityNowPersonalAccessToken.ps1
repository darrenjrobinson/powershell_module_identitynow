    ...
    if ($v3Token.access_token) {
        try {    
            ...
            if ($IDNGetPAT.count -gt 0) {
                ...
                return "No 'Personal Access Tokens' found. Use New-IdentityNowPersonalAccessToken or the IdentityNow Portal to create a personal access token."
            }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUyj1orPOWly+ZUuTvBTGX14tp
# qjCgggqNMIIFMDCCBBigAwIBAgIQBAkYG1/Vu2Z1U0O1b5VQCDANBgkqhkiG9w0B
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEZE+WP7psz1
# y/Krl1yo52J/W8yoMA0GCSqGSIb3DQEBAQUABIIBABEejmTWicOkNRb8NWV9B/TU
# sYSvz+gmxXa2fFrdnlxn+38sZN9iLeZaNGEONd+rLHgF+FEagbD9eyOftykiwiVC
# hu5A0lQ5R53VxNC+pfHBSPxVSTfuUXjH7jTrS3yk9Tw5haNW/hYqbb8zXdhkGItu
# NMsFGBVD0yCVmLQJ/IRgBlSj+6Yc13/wT7hQz1CuZuNc0bfLD7ZGSXDXQaztGP5F
# PUi2UZXAhDeaYf+e4v0oljiU1OK7TjFCHWGTC9SpJWEinbDcc1yS3QJ0ZopmbH/B
# /BtPx3cHknopNjjulO+5cfOsuq0Scb/JuCOfXJdkgxdwRwqk3ohVXP8GWg70E1M=
